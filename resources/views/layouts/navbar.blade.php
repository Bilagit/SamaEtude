...
<head>
    ...
    .custom-navbar .navbar-toggler {
        ...
        /* Couleur pour l'icône de toggle */
    }
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/etudiant') }}">Cours</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/exercices') }}">Exercices</a>
                    </li>
                    @endif
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="{{ url('/profil') }}"><i class="fas fa-user"></i> Profil</a>
