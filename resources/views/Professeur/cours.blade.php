        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Bienvenu(e) Mr. Bassirou Touré</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <button class="btn btn-success"><img src="{{ asset('img/plus.svg') }}" class="white-icon"
                                width="16" height="16" alt=""> Ajouter un Cours</button>
                    </div>
                </div>
                <br>
        ...
        <button class="btn btn-outline-success" type="submit">Search</button>
                        ...
                        <nav>
                            <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                                ...
                                <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">IPDL</button>
                                <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact"
                                    aria-selected="false">Programmation Web</button>
                            </div>
                            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                                ...
                                <div class="col">
                                    <div class="card shadow-sm">
                                        <img src="{{ asset('img/images.jpeg') }}" class="rounded" width="100%"
                                            height="225" alt="">
                                        <div class="card-body">
                                            <p class="card-text">Programmation Orientée Objet</p>
                                            <p class="card-text"><strong>informatique</strong></p>
                    ...
                    <div class="table-responsive small">
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="{{ asset('img/images.jpeg') }}" class="rounded" width="90%"
                                            height="60" alt=""></td>
                                    <td>Programation orientée Objet <br><small>Ajoutée le 24 juin 2024</small> </td>
                                    <td>
                                        <span
                                            ...
                                            <img class="rounded-circle me-1" width="32" height="32"
                                                src="https://github.com/mdo.png" alt="">Mr. Bassirou Touré
                                        </span>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                ...
                                <tr>
                                    <td><img src="{{ asset('img/téléchargement.png') }}" class="rounded" width="90%"
                                            height="60" alt=""></td>
                                    <td>Exercice 1 <br><small>Ajoutée le 24 juin 2024</small> </td>
                                    <td>
                                        <span
                                            class="badge d-flex align-items-center p-1 pe-2 text-success-emphasis bg-success-subtle border border-success-subtle rounded-pill">
                                            <img class="rounded-circle me-1" width="32" height="32"
